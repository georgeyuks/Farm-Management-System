...
--
-- Table structure for table `livestockpurchase`
--

CREATE TABLE `LivestockPurchase` (
  `LivestockPurchase_ID` int(11) NOT NULL,
  `Date` date NOT NULL,
  `NumberOfLivestock` int(11) NOT NULL,
  `Price` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `LivestockPurchase`
--

INSERT INTO `LivestockPurchase` (`LivestockPurchase_ID`, `Date`, `NumberOfLivestock`, `Price`) VALUES


-- --------------------------------------------------------

--
-- Table structure for table `LivestockMortality`
--

CREATE TABLE `LivestockMortality` (
  `LivestockMortality_ID` int(11) NOT NULL,
  `Date` date NOT NULL,
  `Deaths` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `LivestockMortality`
--

INSERT INTO `LivestockMortality` (`LivestockMortality_ID`, `Date`, `Deaths`) VALUES
...
ALTER TABLE `BirdsPurchase`
  ...
  --
-- Indexes for table `LivestockMortality`
--
ALTER TABLE `LivestockMortality`
  ADD PRIMARY KEY (`LivestockMortality_ID`);

  --
-- Indexes for table `LivestockPurchase`
--
ALTER TABLE `livestockpurchase`
  ADD PRIMARY KEY (`LivestockPurchase_ID`);
...
ALTER TABLE `BirdsPurchase`
  ...
  --
-- AUTO_INCREMENT for table `LivestockMortality`
--
ALTER TABLE `LivestockMortality`
  MODIFY `LivestockMortality_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

  --
-- AUTO_INCREMENT for table `LivestockPurchase`
--
ALTER TABLE `LivestockPurchase`
  MODIFY `LivestockPurchase_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
