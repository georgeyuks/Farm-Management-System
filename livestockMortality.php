            ...
            <div class="main__container">
                ...
                <table>
                    ...
                    <?php
                        ...
                        $myrow = $livestockMortalityObject->viewMethod("LivestockMortality");
                        $i = 0;
                        foreach($myrow as $row){
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="edit_btn" href="livestockMortality.php?livestockmortupdate=1&id=<?php echo $row["LivestockMortality_ID"]; ?>">Edit</a>
                                    
                                </td>
                                <td>
                                <a class="del_btn" href="includes/action.php?livestockmortdelete=1&id=<?php echo $row["LivestockMortality_ID"]; ?>">Delete</a>                    
                                </td>
                            </tr>
                            <?php
